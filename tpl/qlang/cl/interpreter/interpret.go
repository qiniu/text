...
import (
	...
	qlang "github.com/qiniu/text/tpl/qlang/cl"
)
...
type Engine struct {
	*tpl.CompileRet
	Interpreter *qlang.Object
	mute        int
}

var (
	optionsDef Options
	typeFunc   = reflect.TypeOf((*qlang.Function)(nil))
)
...
func call(ip *qlang.Object, name string) interface{} {
...
func callN(ip *qlang.Object, name string, args ...interface{}) interface{} {
...
func callFn(stk *qlang.Object, fn interface{}, arity int) {
...
func callVfn(stk *qlang.Object, fn *qlang.Function, arity int) {
...
func (p *Engine) EvalCode(fn *qlang.Object, name string, src interface{}) error {
